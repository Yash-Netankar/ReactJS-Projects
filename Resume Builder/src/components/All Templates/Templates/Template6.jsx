        ...
        {/* section 1 */}
            ...
            {/* name_social */}
                <div className="name_social">
                    ...
                    <p><i style={{color:"#e67e22"}} className='fas fa-user-alt'></i>{this.props.post}</p>
                    <p><i style={{color:"#e67e22"}} className='fas fa-at'></i>{this.props.email}</p>
                    <a href={this.props.github}><i style={{color:"#e67e22"}} className='fab fa-github'></i>Github</a>
                    <a href={this.props.linkedIn}><i style={{color:"#e67e22"}} className='fab fa-linkedin-in'></i>LinkedIn</a>
                </div>
            {/* about */}
                <div className="about_container">
                    <h1 className="about_heading"><i style={{color:"#e67e22"}} className="far fa-edit"></i>Professional Summary</h1>
                    <p className="about">{this.props.about}</p>
                </div>
            {/* experience */}
                <div className="exp_container">
                    <h1 className="exp_heading"><i style={{color:"#e67e22"}} className='fas fa-globe'></i>Employement History</h1>
                    <p className="exp_name">{this.props.expname}</p>
                    <p className="exp_desc">{this.props.expdesc}</p>
                </div>
            {/* education */}
                <div className="ed_container">
                    <h1 className="ed_heading"><i style={{color:"#e67e22"}} className='fas fa-graduation-cap'></i>Education</h1>
                    <p className="ed_name">{this.props.edname}</p>
                    <p className="ed_desc">{this.props.eddesc}</p>
                </div>
            {/* projects */}
                <div className="project_container">
                    <h1 className="pro_heading"><i style={{color:"#e67e22"}} className="fas fa-lightbulb"></i>Projects OR Activities</h1>
            ...
            <section className="sec2">
                <div className="sk_container">
                    <h1 className="sk_heading"><i style={{color:"#e67e22"}} className='fab fa-gratipay'></i>Skills</h1>
                ...
                <div className="tool_container">
                    <h1 className="tool_heading"><i style={{color:"#e67e22"}} className='fas fa-tools'></i>Tools</h1>
                ...
                <div className="lang_container">
                    <h1 className="lang_heading"><i style={{color:"#e67e22"}} className='fas fa-microphone'></i>Languages</h1>
                    <div className="lang">
